...
détriment de la performance (parcours d'arbre plutôt que bytecode) ; la
\emph{simplicité} au détriment de l'exhaustivité (pas de portée de bloc, pas de
typage statique, back-end entier uniquement) ; et la \emph{fidélité à la
spécification} là où elle était claire, avec arbitrage explicite là où elle se
contredisait (portée lexicale, terminateurs d'instruction). Ces choix sont
cohérents avec la finalité pédagogique du projet.
